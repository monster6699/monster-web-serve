...
user_api.add_resource(passport.AuthorizationResource, '/security/oauth/token',
...
user_api.add_resource(administrator.CurrentUserResource, '/user/info',
                      endpoint='CurrentUserResource')
user_api.add_resource(administrator.CurrentUserMenu, '/user/menu',
                      endpoint='CurrentUserMenu')
